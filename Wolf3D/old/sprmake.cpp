...
int             Process             (BinFile*);
GameSprite3D*   ProcessSpriteHeader (BinFile*,const Param&);
Sprite3D*       ProcessSpriteFace   (BinFile*,const Param&);
SimpleSprite*   ProcessSpriteImage  (BinFile*,const Param&);
