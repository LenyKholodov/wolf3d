...
public:
        ...
        void          loadPlayPal      ();
        void          loadColorMap     ();
        tTexture *    loadTexture      ( const char * name );
        tTexture *    loadFloorTexture ( const char * name );
        tPic     *    loadPic          ( const char * name );
        int           locateResource   ( const char * name );
        void          loadTexture1     ();
        void          loadPNames       ();
        void          applyPatch       ( tTexture * tex, TexturePatch& patch );

        int           findEntries  ( const char* first, char**);
};
