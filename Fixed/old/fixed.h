...
const Fixed     FX_ONE       =    int2fixed(1);
const Fixed     FX_HALF      =    float2fixed(0.5);
const Fixed     FX_VERY_LOW  =    float2fixed(0.0001);
...
const Angle     ANGLE_90     =   float2angle(FL_PI/2.0);
const Angle     ANGLE_120    =   ANGLE_60*2;
const Angle     ANGLE_180    =   float2angle(FL_PI);
const Angle     ANGLE_270    =   float2angle(FL_ANGLE_180*1.5);
const Angle     ANGLE_360    =   float2angle(2.0*FL_PI);
